...
/**
 * JUnit rule that creates a [TestApplicationComponent] and injects the [TestCountryFactApplication].
 *
...
class DaggerTestApplicationRule : TestWatcher() {
    ...
    override fun starting(description: Description?) {
        ...
        val app = ApplicationProvider.getApplicationContext<Context>() as TestCountryFactApplication
